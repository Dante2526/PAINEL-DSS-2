...
const Header: React.FC<HeaderProps> = ({ stats, loading, onAdminClick, isDarkMode, onToggleDarkMode }) => {
    return (
        <header className="bg-light-card dark:bg-dark-card rounded-3xl p-8 mb-8 shadow-lg flex flex-row justify-between items-center gap-6 w-full transition-colors">
